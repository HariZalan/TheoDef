...
if (isset ($_GET ["gnum"])) {
  ...
  $toParse = str_replace("<proof>","<proof>A bizonyítás: ", $toParse);
  $toParse = str_replace("<description>","<description>A tétel érthetőbb formában: ", $toParse);
  $toParse = str_replace("<date>","<hr/><date>A változat dátuma: ", $toParse);
  $toParse = str_replace("<author>","<author>A szerző: ", $toParse);
  $toParse = str_replace("<changes>","<changes>A változtatások összefoglalva: ", $toParse);
